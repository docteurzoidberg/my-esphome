...
class WebServer : public Controller, public Component, public AsyncWebHandler {
 public:
  WebServer(web_server_base::WebServerBase *base, zilloscope::ZilloScope *zillo) : base_(base), zillo_(zillo), entities_iterator_(ListEntitiesIterator(this)) {}
  ...
  bool handle_buffer_request(AsyncWebServerRequest *request, uint8_t *data, size_t len, size_t index, size_t total );
  void handle_setpixel_request(AsyncWebServerRequest *request, const UrlMatch &match);
