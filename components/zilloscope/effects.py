...
from .types import DisplayRef, DisplayLambdaEffect, DisplayFireEffect, DisplayBubblesEffect, DisplaySnowEffect, DisplayMatrixEffect, DisplayTiledPuzzleEffect
...
def display_lambda_effect_to_code(config, effect_id):
    args = [(DisplayRef, 'it'), (int, 'frame'), (bool, 'initial_run')]
